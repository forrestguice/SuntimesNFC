...
public class AppThemes extends AppThemeInfo.AppThemeInfoFactory
{
    ...
    public int getDefaultThemeID() {
        return R.style.Theme_SuntimesNFC_Dark;
    }
    ...
    public static class SystemThemeInfo extends AppThemeInfo
    {
        ...
        public int getStyleId(Context context, TextSize size) {
            switch (size) {
                case SMALL: return R.style.Theme_SuntimesNFC_System_Small;
                case LARGE: return R.style.Theme_SuntimesNFC_System_Large;
                case XLARGE: return R.style.Theme_SuntimesNFC_System_XLarge;
                case NORMAL: default: return R.style.Theme_SuntimesNFC_System;
            }
        }
    }
    ...
    public static class LightThemeInfo extends AppThemeInfo
    {
        ...
        public int getStyleId(Context context, TextSize size) {
            switch (size) {
                case SMALL: return R.style.Theme_SuntimesNFC_Light_Small;
                case LARGE: return R.style.Theme_SuntimesNFC_Light_Large;
                case XLARGE: return R.style.Theme_SuntimesNFC_Light_XLarge;
                case NORMAL: default: return R.style.Theme_SuntimesNFC_Light;
            }
        }
    }
    ...
    public static class DarkThemeInfo extends AppThemeInfo
    {
        ...
        public int getStyleId(Context context, TextSize size) {
            switch (size) {
                case SMALL: return R.style.Theme_SuntimesNFC_Dark_Small;
                case LARGE: return R.style.Theme_SuntimesNFC_Dark_Large;
                case XLARGE: return R.style.Theme_SuntimesNFC_Dark_XLarge;
                case NORMAL: default: return R.style.Theme_SuntimesNFC_Dark;
            }
        }
    }
    ...
    public static class ContrastSystemThemeInfo extends AppThemeInfo
    {
        ...
        public int getStyleId(Context context, TextSize size) {
            switch (size) {
                case SMALL: return R.style.Theme_SuntimesNFC_System1_Small;
                case LARGE: return R.style.Theme_SuntimesNFC_System1_Large;
                case XLARGE: return R.style.Theme_SuntimesNFC_System1_XLarge;
                case NORMAL: default: return R.style.Theme_SuntimesNFC_System1;
            }
        }
    }
    ...
    public static class ContrastLightThemeInfo extends AppThemeInfo
    {
        ...
        public int getStyleId(Context context, TextSize size) {
            switch (size) {
                case SMALL: return R.style.Theme_SuntimesNFC_Light1_Small;
                case LARGE: return R.style.Theme_SuntimesNFC_Light1_Large;
                case XLARGE: return R.style.Theme_SuntimesNFC_Light1_XLarge;
                case NORMAL: default: return R.style.Theme_SuntimesNFC_Light1;
            }
        }
    }
    ...
    public static class ContrastDarkThemeInfo extends AppThemeInfo
    {
        ...
        public int getStyleId(Context context, TextSize size) {
            switch (size) {
                case SMALL: return R.style.Theme_SuntimesNFC_Dark1_Small;
                case LARGE: return R.style.Theme_SuntimesNFC_Dark1_Large;
                case XLARGE: return R.style.Theme_SuntimesNFC_Dark1_XLarge;
                case NORMAL: default: return R.style.Theme_SuntimesNFC_Dark1;
            }
        }
    }
